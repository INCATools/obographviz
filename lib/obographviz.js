...
OboGraphViz.prototype.createDigraph = function(nestedRelations, styleMap, highlightIds) {
    ...
    for (i=0; i<og.graphs.length; i++) {
        ...
        for (j=0; j<nodes.length; j++) {
            ...
            // highlight this node
            if (highlightIds.indexOf(n.id) > -1) {
                properties.penwidth = 10
            }
            ...
            if (this.isSelected(n, styleMap.nodeFilter)) {
                ...
                dotgraph.setNode(nid, properties)
            }
        }
        ...
        for (j=0; j<edges.length; j++) {
            ...
            if (nestedRelationsDirect.indexOf(pred) > -1) {
                ...
                if (cgraph.hasNode(subj)) {
                    ...
                    dotgraph.setEdge(from, to, properties, ename)
                    ...
                    dotgraph.setEdge(dsubj, dobj, properties, ename)
                }
            }
        }
